    ...
    <PageContainer>
      <section className="results-card" style={{ width: '100%', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(360px, 1fr))', gap: '1.8rem', alignItems: 'start' }}>
          ...
          {/* Left Column: Core Safety Findings & Source */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.6rem' }}>
            
            {/* 4 Core Analysis Cards in 2x2 Grid */}
            ...
            {/* Analyzed Source Content Box */}
            <div style={{ padding: '1.2rem 1.4rem', background: 'var(--surface-alt)', border: '1px solid var(--border)', borderRadius: '20px' }}>
          ...
          {/* Right Column: Breakdown, Sharing & Action Tools */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.6rem' }}>
            
            {/* Risk Indicator Breakdown */}
            <div style={{ padding: '1.4rem', background: 'var(--surface-alt)', border: '1px solid var(--border)', borderRadius: '20px' }}>
            ...
            <div style={{ padding: '1.4rem', background: 'var(--surface-alt)', border: '1px solid var(--border)', borderRadius: '20px' }}>
              ...
              <div style={{ background: 'var(--surface)', padding: '0.85rem 1rem', borderRadius: '12px', fontSize: '0.82rem', border: '1px solid var(--border)', fontFamily: 'monospace', whiteSpace: 'pre-wrap', color: 'var(--text)', marginBottom: '1rem', lineHeight: 1.45 }}>
                {shareText}
              </div>
            ...
            <div style={{ display: 'flex', gap: '0.8rem', flexWrap: 'wrap' }}>
              <Button onClick={() => navigate('/dashboard')} style={{ padding: '0.65rem 1.2rem', fontSize: '0.86rem' }}>
                Back to Dashboard
              </Button>
              <Button variant="secondary" onClick={() => setIsReportModalOpen(true)} style={{ padding: '0.65rem 1.2rem', fontSize: '0.86rem' }}>
                Report Scam (CSA 292)
              </Button>
              <Button variant="ghost" onClick={copyReport} style={{ background: 'var(--surface)', border: '1px solid var(--border)', padding: '0.65rem 1.1rem', fontSize: '0.86rem' }}>
